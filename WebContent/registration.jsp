...
<input type="text" name="FIRSTNAME" size="25" maxlength="40" pattern="[a-zA-Z0-9@.-()#_]{0,100}"></input></td> 
...
Last Name: </td><td><input type="text" name="LASTNAME" size="25" maxlength="40"pattern="[a-zA-Z0-9@.-()#_]{0,100}"></input></td>
...
Visitor Name:</td><td><input type="text" name="USERNAME" size="25" maxlength="40" pattern="[a-zA-Z0-9@.-()#_]{0,100}"></input></td> 
...
Password:</td><td><input type="password" name="PASSWORD" size="27" maxlength="40" pattern="[a-zA-Z0-9@.-()#_]{0,100}"></input></td>
...
Confirm Password:</td><td><input type="password" name="CPASSWORD" size="27" maxlength="40" pattern="[a-zA-Z0-9@.-()#_]{0,100}"></input></td>
...
Email: </td><td> <input type="text" name="EMAIL" size="25" maxlength="50" pattern="[a-zA-Z0-9@.-()#_]{0,100}"></input></td> 
...
Phone Number:</td><td><input type="text" name="PHONENO" size="25" maxlength="40" pattern="[a-zA-Z0-9@.-()#_]{0,100}"></input></td>
...
<td> Address:</td><td> <input type="text" name="ADDRESS" size="25" maxlength="30" pattern="[a-zA-Z0-9@.-()#_]{0,100}"></input> </td>
