				...
				<td>
												...
												<tr>
													<td width="1000">
														<div id="coursesbody" align="left">
															...
															<p class="style1">
																Address: <jstlcore:out value="${visitor.address}"></jstlcore:out></p>
														</div>
													</td>
												</tr>
											</table> <br />
					...
					<div id="content" align="center">
						...
						<table class="content" width="96%" border="1" align="center">
							...
							<jstlcore:if test = "${allEvents.size()==0}">
							alert("There are currently no events upcoming.  Please check back later.  Thanks for visiting the event portal");
							</jstlcore:if>
									...
									<jstlcore:choose>
										<jstlcore:when test="${event[6] != 0}">
											<td width="100px" bgcolor="#CCCC99" align="center"><jstlcore:out
													value="${event[6]}"></jstlcore:out> <strong>
													tickets left.</strong> <a
