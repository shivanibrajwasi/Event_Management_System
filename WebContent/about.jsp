						...
						<td>
							<div id="content">
								<p>FERS, or the Festival Event Registration System, is
									provided as a free service of the New Codington City Council,
									to the citizens and visitors of the city of New
									Codington. FERS allows visitors to easily view and register for
									various events and activities in the New Codington area.</p>
								<br />
								<p>FERS is a result of a joint venture with Accenture, Ltd and the
									New Codington City Council. Please submit any questions,
									comments or concerns about the usage, registration, event
									availability, or any other information presented on this
									website to the New Codington City Council at
									questions@newcodcc.gov.</p>
								<br></br>
								<p align="center" style="font-family: calibri; color: #6666CC;">Please
									note that any events or activities that are scheduled via the
									...
									for the latest event status and ticket availability. While using this
								...
								<p align="center" style="font-family: calibri; color: #6666CC;">©Copyright,
									2012 by the New Codington City Council. All Rights
									Reserved.</p>
							</div>
						</td>
					</tr>
